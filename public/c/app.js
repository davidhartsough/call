...
var $kKvpS$peerjsjsbinarypack = /*@__PURE__*/getDefaultExportFromCjs(binarypack);
...
var SDPUtils$1 = /*@__PURE__*/getDefaultExportFromCjs(sdpExports);
...
var shimRTCPeerConnection = /*@__PURE__*/getDefaultExportFromCjs(rtcpeerconnection);
...
function openCall$1(peerId, localStream) {
    const peer = new $70d766613f57b014$export$2e2bcd8739ae039(peerId);
    const handleError = (err) => {
        console.log("err:", err);
        peer.destroy();
        openCall$1(peerId, localStream);
    };
...
function setupGuest(id, localStream) {
    openCall$1(id, localStream);
}

function openCall(peerId, localStream) {
    const peer = new $70d766613f57b014$export$2e2bcd8739ae039(peerId);
    const handleError = (err) => {
        console.log("err:", err);
        peer.destroy();
...
function setupHost(id, localStream) {
    openCall(id, localStream);
}

function checkIfHost(id) {
...
function initialize(id, localStream) {
